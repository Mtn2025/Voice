"""
DetectTurnEndUseCase - Module 14 (VAD Timer Domain Ownership).
...
class DetectTurnEndUseCase:
    ...
    def should_end_turn(self, silence_duration_ms: int) -> bool:
        ...
        Example:
            >>> use_case.should_end_turn(600)  # 600ms > 500ms threshold
            True
            >>> use_case.should_end_turn(300)  # 300ms < 500ms threshold
            False
        """
