...
async def dashboard(
    ...
    voices = await cache.get("voices_metadata_v5")
    ...
    if not voices:
        ...
        await cache.set("voices_metadata_v5", voices, ttl=86400)
    else:
    ...
    # Styles - Try cache
    voice_styles_cached = await cache.get("voice_styles_v5")
    if not voice_styles_cached:
        ...
        await cache.set("voice_styles_v5", voice_styles, ttl=86400)
    else:
